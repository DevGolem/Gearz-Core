 ...
 */
public abstract class GearzCommand implements CommandExecutor, TabExecutor 
{
    ...
    public GearzCommand(String command)
    {
        this(command, null, null, null, null);
    }

    public GearzCommand(String command, String usage)
    {
        this(command, usage, null, null, null);
    }

    public GearzCommand(String command, String usage, String description)
    {
        this(command, usage, description, null, null);
    }

    public GearzCommand(String command, String usage, String description, String permissionMessage)
    {
        this(command, usage, description, permissionMessage, null);
    }

    public GearzCommand(String command, String usage, String description, List<String> aliases)
    {
        this(command, usage, description, null, aliases);
    }

    public GearzCommand(String command, String usage, String description, String permissionMessage, List<String> aliases)
    {
    ...
    {
        private GearzCommand exe = null;
        protected ReflectCommand(String command)
        {
            super(command);
        }

        public void setExecutor(GearzCommand exe)
        {
            this.exe = exe;
        }
